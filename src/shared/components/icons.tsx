...
export function CheckListIcon({ size = 16, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M9 11H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6a2 2 0 0 0-2-2h-5M9 11V9a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2M9 11v8M7 9v2" />
